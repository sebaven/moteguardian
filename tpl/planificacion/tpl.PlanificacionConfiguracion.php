		...
		<table width="70%" align="center" border="0">
			...
			<tr>
				...
				<td>
					...
					<button type="button" id="mostrarCalendario"><img src="imagenes/calendario.png"/></button><?= getCalendarDefinition( "fecha", "mostrarCalendario"); ?>
				</td>
				<td align="right">					
			...
			<tr>				
				<td colspan="3" align="center"><br/>* Fecha de vigencia <input type="text" id="fecha_vigencia" name="fecha_vigencia" readonly="readonly" size="10" value="<?= $fecha_vigencia?>" /><button type="button" id="mostrarCalendarioVigencia"><img src="imagenes/calendario.png"/></button><?= getCalendarDefinition( "fecha_vigencia", "mostrarCalendarioVigencia"); ?></td>
			</tr>				
  		</table>
  		<br/>
		<div align="center">
