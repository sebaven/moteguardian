...
function finalizarPorError() {
	...
	// FIXME: POR DIOS! que antes cierre los procesos_ejecutandose 
...
function tamanoArchivos($tamanoArchivoRemoto, $nombreArchivoLocal){
		...
		//Veo si el tamaño del Archivo Remoto es igual al del Archivo Local
		if ($tamanoArchivoRemoto==$tamanoLocal)
			return true;
		else
		    return false;
}
