...
class ListadoPlanificacionEnvio extends Listado
{
	function ListadoPlanificacionEnvio ($params)
	{
		parent::Listado();
		$planificacionDAO = new PlanificacionDAO();

		// Cargar la consulta para el listado
		$sql = $planificacionDAO->getSqlPlanificacionesEnvio($params);
		...
		if($_POST['id_envio']) $params['id_envio'] = $_POST['id_envio'];
		if($_GET['id_envio']) $params['id_envio'] = $_GET['id_envio'];
